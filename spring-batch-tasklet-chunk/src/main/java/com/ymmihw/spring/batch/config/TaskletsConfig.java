...
import com.ymmihw.spring.batch.tasklets.LinesProcessor;
import com.ymmihw.spring.batch.tasklets.LinesReader;
import com.ymmihw.spring.batch.tasklets.LinesWriter;
...
public class TaskletsConfig {
  ...
  @Bean
  public Job job() {
    return jobs.get("taskletsJob").start(readLines()).next(processLines()).next(writeLines())
        .build();
  }
