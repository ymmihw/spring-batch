package com.ymmihw.spring.batch;
...
import com.ymmihw.spring.batch.service.CustomItemProcessor;
...
public class SpringBatchConfig {
  ...
  protected Step step1(ItemReader<Transaction> reader,
    ...
    return steps.get("step1").<Transaction, Transaction>chunk(10).reader(reader)
